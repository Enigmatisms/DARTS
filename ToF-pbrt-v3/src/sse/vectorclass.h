...
#include "sse/instrset.h"        // Select supported instruction set
...
#else
#warning "Device instruction set is below 8"
...
#include "sse/vector_convert.h"  // conversion between different vector sizes, and common templates
