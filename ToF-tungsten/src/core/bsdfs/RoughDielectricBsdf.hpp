...
public:
    ...
    static bool sampleBase(SurfaceScatterEvent &event, bool sampleR, bool sampleT,
            float roughness, float ior, Microfacet::Distribution distribution, bool no_transmit = false);
    ...
    static bool invertBase(WritablePathSampleGenerator &sampler, const SurfaceScatterEvent &event,
            bool sampleR, bool sampleT, float roughness, float ior, Microfacet::Distribution distribution, bool no_transmit = false);
